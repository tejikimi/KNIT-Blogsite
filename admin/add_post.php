...
<body>
      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <div class="navbar-header">
            <a class="navbar-brand" href="index.php"><img style="width:220px;height:35px;" src="images/knitsol-logo.png"></a>
          </div>
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="text-default">
            <div class="text-center"><strong>Add Your Post </strong></div>
          </h3>
        </div>
          ...
          <form method="post" action="#" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select name="cat" class="form-control ">
                ...
                ?>
                    <option><?php echo $row['id']; ?> <?php echo $row['text']; ?></option>
                <?php }
                } ?>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="description" placeholder="Write Here Post Description">
            </div>

            <div class="form-group">
              <label>Post Content:</label>
              <textarea class="form-control" name="contents" rows="25" cols="200" id="textarea" placeholder="Write Here Post Content"></textarea>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" name="authors" class="form-control" placeholder="Author Name">
            </div>

            <div class="form-group ">
              <label>Tags:</label>
              <input type="text" name="tags" class="form-control" placeholder="Tages Name">
            </div>
            <div class="form-group">
        ...
        <button type="submit" name="btn" class="btn btn-primary">Submit</button> <a href="index.php" type="submit" class="btn btn-danger">Cancel</a>
        </form>
        ...
        if (isset($_POST["btn"])) {
          ...
          $content =  htmlspecialchars($_POST['contents'], ENT_QUOTES);
          // $_POST["contents"];
          ...
          if (!empty($_FILES["image"]["name"])) {
            ...
            if (in_array($fileType, $allowTypes)) {
              ...
              $sql = "insert into posts(category,title,content,author,tags,date,img,description) values('" . $category . "','" . $title . "','" . $content . "','" . $author . "','" . $tags . "', '" . $date . "','" . $imgContent . "' ,'" . $description . "')";
              // echo "<script>console.log('sql',$sql);</script>";
              $n = mysqli_query($con, $sql);
              // echo "<script>alert('Sucessfully Post Added',$n)</script>";
              // echo "<script>alert('Sucessfully Post Added',$sql)</script>";
              if ($n == 1) {
                // echo "<script>console.log('sql',$sql);</script>";
                echo "<script>alert('Sucessfully Post Added')</script>";
                echo "<script>location.href='add_post.php'</script>";
              } else {
                // echo "<script>console.log('sql',$sql);</script>";
              }
            }
  ...
  <!-- <script src="https://cloud.tinymce.com/stable/tinymce.min.js?apiKey=9l3qt58sygqstmz5v5yhcr0v2nfs4e4ufcmyo8pg98549ykv"></script> -->
  ...
  <script>
    ...
    var demoBaseConfig = {
      ...
      toolbar: "undo redo print | styleselect | fontselect fontsizeselect bold italics underline forecolor backcolor | link image | alignleft aligncenter alignright alignjustify |lineheight | numlist bullist indent outdent | removeformat",
      content_css: [
