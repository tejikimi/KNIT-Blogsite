      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <h2 class="text-warning">
            <div class="alert alert-success bg-warning text-center"><strong>Update Post</strong></div>
          </h2>
          ...
          if (mysqli_num_rows($post) == 1) {
            $single = mysqli_fetch_array($post);
          ...
          ?>
            ...
            <form method="post">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="contents" rows="3"><?php echo $single['content']; ?></textarea>

                <div class="form-group ">
                  <label>Tags:</label>
                  <input type="text" name="tags" class="form-control" value="<?php echo $single['tags']; ?>">
                </div>
              </div>
              <button type="submit" name="upbtn" class="btn btn-primary">Update</button> <a class="btn btn-danger" href="index.php">Cancel</a>
            </form>
          <?php } ?>
